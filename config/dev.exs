...
config :event_manager, EventManagerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Kn8CUIEYZ1sBOa+yRB2ra8oGaGmFLBQwMLqGMcNe+gFfRYve/9FOKQdSaqKLl22+",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:event_manager, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:event_manager, ~w(--watch)]}
  ]
